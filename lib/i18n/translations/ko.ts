...
export default {
    ...
    settings: {
        ...
        lightDark: '라이트 / 다크',
        exitLabel: '종료',
        exportDataTitle: '내 데이터 요청',
        exportDataDesc: '개인 데이터 사본을 받으시려면 privacy@odysseyjournal.app으로 연락해 주세요. 프로필, 게시물, 댓글, 컬렉션, 연결 정보를 내보내 보내 드립니다.',
        exportDataSubdesc: '이메일로 개인 데이터 사본을 요청하세요',
        sendEmail: '이메일 보내기',
        legal: '법률 및 커뮤니티',
