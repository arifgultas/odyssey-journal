...
export default {
    ...
    settings: {
        ...
        deleteAccountConfirm: 'Вы уверены, что хотите удалить свой аккаунт? Это действие необратимо.\n\nЕсли вы хотите сначала получить копию своих данных, напишите на privacy@odysseyjournal.app, и мы подготовим её для вас.',
        ...
        exitLabel: 'ВЫХОД',
        exportDataTitle: 'Запросить мои данные',
        exportDataDesc: 'Чтобы получить копию своих персональных данных, напишите на privacy@odysseyjournal.app. Мы выгрузим ваш профиль, публикации, комментарии, коллекции и связи и отправим их вам.',
        exportDataSubdesc: 'Напишите нам, чтобы получить копию своих данных',
