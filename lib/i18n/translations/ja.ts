...
export default {
    ...
    settings: {
        ...
        lightDark: 'ライト / ダーク',
        exitLabel: '終了',
        exportDataTitle: 'データのコピーを依頼',
        exportDataDesc: '個人データのコピーが必要な場合は、privacy@odysseyjournal.app までご連絡ください。プロフィール、投稿、コメント、コレクション、つながりをエクスポートしてお送りします。',
        exportDataSubdesc: 'メールで個人データのコピーを依頼できます',
        sendEmail: 'メールを送信',
        legal: '法的情報とコミュニティ',
