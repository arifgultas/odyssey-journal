...
export default {
    ...
    settings: {
        ...
        exportDataTitle: 'Verilerimi İste',
        exportDataDesc: 'Kişisel verilerinizin bir kopyasını almak için privacy@odysseyjournal.app adresine yazın. Profilinizi, gönderilerinizi, yorumlarınızı, koleksiyonlarınızı ve bağlantılarınızı dışa aktarıp size gönderelim.',
        exportDataSubdesc: 'Kişisel verilerinizin kopyası için bize e-posta gönderin',
