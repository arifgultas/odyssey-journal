...
export default {
    ...
    settings: {
        ...
        lightDark: 'فاتح / داكن',
        exitLabel: 'خروج',
        exportDataTitle: 'طلب بياناتي',
        exportDataDesc: 'للحصول على نسخة من بياناتك الشخصية، راسلنا على privacy@odysseyjournal.app. سنصدّر ملفك الشخصي ومنشوراتك وتعليقاتك ومجموعاتك واتصالاتك ونرسلها إليك.',
        exportDataSubdesc: 'راسلنا للحصول على نسخة من بياناتك الشخصية',
        ...
        moderationPanelDesc: 'مراجعة البلاغات وإدارة المستخدمين',
    ...
    errors: {
        ...
        boundaryTitle: 'لقد أضعنا بوصلتنا!',
        boundarySubtitle: 'حدث خطأ غير متوقع. نعمل على إعادة الأمور إلى مسارها.',
        boundaryErrorDetails: 'تفاصيل الخطأ',
        boundaryRetry: 'إعادة تشغيل التطبيق',
        boundaryShowDetails: 'عرض تفاصيل الخطأ',
        boundaryHideDetails: 'إخفاء تفاصيل الخطأ',
        noConnection: 'لا يوجد اتصال بالإنترنت',
        permissionPhotos: 'نحتاج إلى إذن الوصول إلى معرض الصور لتحميل الصور.',
        permissionCamera: 'نحتاج إلى إذن الكاميرا لالتقاط الصور.',
        permissionLocation: 'نحتاج إلى إذن الموقع لإضافة الموقع إلى منشوراتك.',
        imagePickFailed: 'فشل اختيار الصورة. يرجى المحاولة مرة أخرى.',
        imagesPickFailed: 'فشل اختيار الصور. يرجى المحاولة مرة أخرى.',
        photoCaptureFailed: 'فشل التقاط الصورة. يرجى المحاولة مرة أخرى.',
        locationFailed: 'فشل الحصول على الموقع الحالي. يرجى المحاولة مرة أخرى.',
    ...
    map: {
        ...
        notSupported: 'الخريطة غير مدعومة',
        locationVisited: 'مكان تمت زيارته',
        locationsVisited: 'أماكن تمت زيارتها',
    ...
    moderation: {
        ...
        categories: {
            ...
            violence: 'عنف',
            'violence/graphic': 'عنف/مشاهد دموية',
        }
    },
    homeLocation: {
    ...
    admin: {
        ...
        noPrivileges: 'ليست لديك صلاحيات المسؤول.',
        goBack: 'رجوع',
        all: 'الكل',
        ...
        total: 'الإجمالي',
        banned: 'محظور',
        reporterNote: 'ملاحظة المُبلِّغ:',
        reportedBy: 'أبلغ عنه: {{name}}',
        anonymous: 'مجهول',
        unknownUser: 'غير معروف',
        dismiss: 'تجاهل',
        deletePost: 'حذف المنشور',
        deletePostConfirm: 'سيتم حذف هذا المنشور نهائيًا. هل أنت متأكد؟',
        deletePostDone: 'تم حذف المنشور وحل البلاغ.',
        deletePostFailed: 'فشل حذف المنشور.',
        banUser: 'حظر المستخدم',
        ban: 'حظر',
        banUserConfirm: 'حظر {{username}}؟ لن يتمكن من إنشاء منشورات أو تعليقات.',
        banUserDone: 'تم حظر {{username}}.',
        banUserFailed: 'فشل حظر المستخدم.',
        dismissFailed: 'فشل تجاهل البلاغ.',
