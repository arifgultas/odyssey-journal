...
export default {
    ...
    settings: {
        ...
        exitLabel: 'QUITTER',
        exportDataTitle: 'Demander mes données',
        exportDataDesc: 'Pour obtenir une copie de vos données personnelles, écrivez à privacy@odysseyjournal.app. Nous exporterons votre profil, vos publications, commentaires, collections et connexions et vous les enverrons.',
        exportDataSubdesc: 'Écrivez-nous pour obtenir une copie de vos données',
