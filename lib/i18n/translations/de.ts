...
export default {
    ...
    profile: {
        ...
        blockUserDesc: 'Sind Sie sicher, dass Sie diesen Benutzer blockieren möchten? Er wird nicht mehr mit Ihnen interagieren können und seine Beiträge werden in Ihrem Feed ausgeblendet.',
        block: 'Blockieren',
    ...
    post: {
        ...
        beFirst: 'Fügen Sie als Erster eine Erinnerung hinzu!',
    ...
    report: {
        ...
        whyReporting: 'Warum melden Sie diesen Beitrag?',
        additionalDetails: 'Zusätzliche Details (optional)',
        detailsPlaceholder: 'Mehr Kontext angeben...',
        submit: 'Meldung senden',
        success: 'Meldung erhalten',
        reasons: {
            spam: { label: 'Spam', desc: 'Wiederholender oder irrelevanter Inhalt' },
            harassment: { label: 'Belästigung oder Mobbing', desc: 'Jemanden angreifen oder belästigen' },
            hate_speech: { label: 'Hassrede', desc: 'Diskriminierender oder beleidigender Inhalt' },
            violence: { label: 'Gewalt oder Drohungen', desc: 'Gewalt fördernd oder drohend' },
            nudity: { label: 'Nacktheit oder sexueller Inhalt', desc: 'Unangemessener sexueller Inhalt' },
            false_information: { label: 'Falschinformation', desc: 'Irreführender oder falscher Inhalt' },
    ...
    settings: {
        ...
        unblockConfirmTitle: 'Benutzer freigeben',
        unblockConfirmDesc: 'Sind Sie sicher, dass Sie diesen Benutzer freigeben möchten?',
        unblockSuccess: 'Der Benutzer wurde freigegeben.',
        ...
        exitLabel: 'BEENDEN',
        exportDataTitle: 'Meine Daten anfordern',
        exportDataDesc: 'Um eine Kopie Ihrer persönlichen Daten zu erhalten, schreiben Sie an privacy@odysseyjournal.app. Wir exportieren Ihr Profil, Ihre Beiträge, Kommentare, Sammlungen und Verbindungen und senden sie Ihnen zu.',
        exportDataSubdesc: 'Fordern Sie per E-Mail eine Kopie Ihrer Daten an',
        sendEmail: 'E-Mail senden',
        legal: 'RECHTLICHES & COMMUNITY',
        communityGuidelines: 'Community-Richtlinien',
        communityGuidelinesDesc: 'Regeln für eine sichere Community',
        adminTitle: 'ADMIN',
    ...
    errors: {
        ...
        boundaryTitle: 'Unser Kompass ist verloren gegangen!',
        boundarySubtitle: 'Ein unerwarteter Fehler ist aufgetreten. Wir arbeiten daran, wieder auf Kurs zu kommen.',
        boundaryErrorDetails: 'Fehlerdetails',
        boundaryRetry: 'App neu starten',
        boundaryShowDetails: 'Fehlerdetails anzeigen',
        boundaryHideDetails: 'Fehlerdetails ausblenden',
        noConnection: 'Keine Internetverbindung',
        permissionPhotos: 'Leider benötigen wir Zugriff auf Ihre Galerie, um Bilder hochzuladen.',
        permissionCamera: 'Leider benötigen wir Kamerazugriff, um Fotos aufzunehmen.',
        permissionLocation: 'Leider benötigen wir Standortzugriff, um Ihren Beiträgen einen Ort hinzuzufügen.',
        imagePickFailed: 'Bild konnte nicht ausgewählt werden. Bitte erneut versuchen.',
        imagesPickFailed: 'Bilder konnten nicht ausgewählt werden. Bitte erneut versuchen.',
        photoCaptureFailed: 'Foto konnte nicht aufgenommen werden. Bitte erneut versuchen.',
        locationFailed: 'Aktueller Standort konnte nicht ermittelt werden. Bitte erneut versuchen.',
    ...
    map: {
        ...
        notSupported: 'Karte nicht unterstützt',
        locationVisited: 'Besuchter Ort',
        locationsVisited: 'Besuchte Orte',
    ...
    guidelines: {
        intro: 'Willkommen bei Odyssey Journal! Wir möchten, dass dieser Raum sicher, inspirierend und auf echte Reiseerlebnisse ausgerichtet bleibt. Bitte befolge diese Richtlinien.',
        respectTitle: 'Respektiere die Community',
        respectDesc: 'Odyssey Journal ist ein Ort, an dem Reisende ihre echten Erlebnisse teilen. Behandle andere mit Respekt. Hassrede, Belästigung, Mobbing und Diskriminierung jeglicher Art sind strengstens verboten.',
        authenticTitle: 'Teile authentische Reisen',
        authenticDesc: 'Konzentriere dich auf Reisen, Orte, Kultur und deine persönliche Reise. Veröffentliche keinen Spam, Werbung, politische Propaganda oder irrelevante Inhalte.',
        safeTitle: 'Sicher und angemessen',
        safeDesc: 'Veröffentliche keine Nacktheit, sexuell expliziten Inhalte oder grafische Gewalt. Stelle sicher, dass deine Fotos und Texte für die Allgemeinheit geeignet sind.',
        privacyTitle: 'Respektiere die Privatsphäre',
        privacyDesc: 'Teile keine persönlichen Informationen anderer ohne deren ausdrückliche Zustimmung. Achte darauf, wen und was du auf deinen Fotos festhältst.',
        enforcementTitle: 'Durchsetzung',
        enforcementDesc: 'Wir überprüfen gemeldete Inhalte und Konten. Verstöße gegen diese Richtlinien können zur Entfernung von Inhalten, eingeschränktem Zugriff oder dauerhafter Löschung des Kontos ohne Vorwarnung führen.',
        thankYou: 'Danke, dass du uns hilfst, Odyssey Journal zu einem großartigen Ort für Reisende zu machen!'
    },
    // Content Moderation
    moderation: {
        ...
        categories: {
            ...
            hate: 'Hassrede',
            'hate/threatening': 'bedrohlicher Hass',
            'self-harm': 'Selbstverletzung',
            'self-harm/intent': 'Absicht zur Selbstverletzung',
    ...
    admin: {
        ...
        noPrivileges: 'Sie haben keine Administratorrechte.',
        goBack: 'Zurück',
        all: 'Alle',
        pending: 'Offen',
        resolved: 'Erledigt',
        ...
        total: 'Gesamt',
        banned: 'Gesperrt',
        reporterNote: 'Hinweis des Melders:',
        reportedBy: 'Gemeldet von: {{name}}',
        anonymous: 'Anonym',
        unknownUser: 'Unbekannt',
        dismiss: 'Ablehnen',
        deletePost: 'Beitrag löschen',
        deletePostConfirm: 'Dieser Beitrag wird dauerhaft gelöscht. Sind Sie sicher?',
        deletePostDone: 'Beitrag gelöscht und Meldung erledigt.',
        deletePostFailed: 'Beitrag konnte nicht gelöscht werden.',
        banUser: 'Nutzer sperren',
        ban: 'Sperren',
        banUserConfirm: '{{username}} sperren? Diese Person kann dann keine Beiträge oder Kommentare erstellen.',
        banUserDone: '{{username}} wurde gesperrt.',
        banUserFailed: 'Nutzer konnte nicht gesperrt werden.',
        dismissFailed: 'Meldung konnte nicht abgelehnt werden.',
