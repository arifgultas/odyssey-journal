  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSCameraUsageDescription:
        "Odyssey Journal needs access to your camera to take photos for your travel posts.",
      NSPhotoLibraryUsageDescription:
        "Odyssey Journal needs access to your photo library to select images for your travel posts.",
      NSLocationWhenInUseUsageDescription:
        "Odyssey Journal needs your location to tag your travel posts and show nearby destinations.",
      NSPhotoLibraryAddUsageDescription:
        "Odyssey Journal needs permission to save photos to your library.",
    },
  },
  android: {
